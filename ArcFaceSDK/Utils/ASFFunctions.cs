...
namespace ArcFaceSDK.Utils
{
    ...
    {
        public const int MOK = 0;//成功
        public const int MERR_ASF_ALREADY_ACTIVATED = 90114;//SDK已激活
        public const int MERR_ASF_NOT_ACTIVATED = 90115;//SDK未激活
        ...
        /// <param name="attributeThreshold">[in] 人脸属性阈值</param>
        /// <returns>调用结果</returns>
        [DllImport(Dll_PATH, EntryPoint = "ASFSetFaceAttributeParam", CallingConvention = CallingConvention.Cdecl)]
        public static extern int ASFSetFaceAttributeParam(IntPtr pEngine, ASF_FaceAttributeThreshold attributeThreshold);
